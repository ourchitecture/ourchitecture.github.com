...
/* harmony import */ var _devops_toolchain_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./devops-toolchain.page */ "./src/app/content/devops-toolchain.page.ts");
/* harmony import */ var _devops_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./devops.page */ "./src/app/content/devops.page.ts");
/* harmony import */ var _diagramming_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./diagramming.page */ "./src/app/content/diagramming.page.ts");
/* harmony import */ var _index_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index.page */ "./src/app/content/index.page.ts");
/* harmony import */ var _internet_of_things_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./internet-of-things.page */ "./src/app/content/internet-of-things.page.ts");
/* harmony import */ var _microservices_page__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./microservices.page */ "./src/app/content/microservices.page.ts");
/* harmony import */ var _people_page__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./people.page */ "./src/app/content/people.page.ts");
/* harmony import */ var _process_page__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./process.page */ "./src/app/content/process.page.ts");
/* harmony import */ var _serverless_page__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./serverless.page */ "./src/app/content/serverless.page.ts");
/* harmony import */ var _technology_page__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./technology.page */ "./src/app/content/technology.page.ts");
/* harmony import */ var _testing_page__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./testing.page */ "./src/app/content/testing.page.ts");
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild([
                    { path: '', component: _index_page__WEBPACK_IMPORTED_MODULE_10__["IndexPage"] },
                    ...
                    { path: 'devops-toolchain', component: _devops_toolchain_page__WEBPACK_IMPORTED_MODULE_7__["DevopsToolchainPage"] },
                    { path: 'devops', component: _devops_page__WEBPACK_IMPORTED_MODULE_8__["DevopsPage"] },
                    { path: 'diagramming', component: _diagramming_page__WEBPACK_IMPORTED_MODULE_9__["DiagrammingPage"] },
                    { path: 'index', component: _index_page__WEBPACK_IMPORTED_MODULE_10__["IndexPage"] },
                    { path: 'internet-of-things', component: _internet_of_things_page__WEBPACK_IMPORTED_MODULE_11__["InternetOfThingsPage"] },
                    { path: 'microservices', component: _microservices_page__WEBPACK_IMPORTED_MODULE_12__["MicroservicesPage"] },
                    { path: 'people', component: _people_page__WEBPACK_IMPORTED_MODULE_13__["PeoplePage"] },
                    { path: 'process', component: _process_page__WEBPACK_IMPORTED_MODULE_14__["ProcessPage"] },
                    { path: 'serverless', component: _serverless_page__WEBPACK_IMPORTED_MODULE_15__["ServerlessPage"] },
                    { path: 'technology', component: _technology_page__WEBPACK_IMPORTED_MODULE_16__["TechnologyPage"] },
                    { path: 'testing', component: _testing_page__WEBPACK_IMPORTED_MODULE_17__["TestingPage"] },
                ]),
            ],
            declarations: [
                _roles_page__WEBPACK_IMPORTED_MODULE_5__["RolesPage"],
                _cloud_page__WEBPACK_IMPORTED_MODULE_6__["CloudPage"],
                _devops_toolchain_page__WEBPACK_IMPORTED_MODULE_7__["DevopsToolchainPage"],
                _devops_page__WEBPACK_IMPORTED_MODULE_8__["DevopsPage"],
                _diagramming_page__WEBPACK_IMPORTED_MODULE_9__["DiagrammingPage"],
                _index_page__WEBPACK_IMPORTED_MODULE_10__["IndexPage"],
                _internet_of_things_page__WEBPACK_IMPORTED_MODULE_11__["InternetOfThingsPage"],
                _microservices_page__WEBPACK_IMPORTED_MODULE_12__["MicroservicesPage"],
                _people_page__WEBPACK_IMPORTED_MODULE_13__["PeoplePage"],
                _process_page__WEBPACK_IMPORTED_MODULE_14__["ProcessPage"],
                _serverless_page__WEBPACK_IMPORTED_MODULE_15__["ServerlessPage"],
                _technology_page__WEBPACK_IMPORTED_MODULE_16__["TechnologyPage"],
                _testing_page__WEBPACK_IMPORTED_MODULE_17__["TestingPage"],
            ]
        })
    ], ContentModule);
...
/***/ "./src/app/content/devops-toolchain.page.ts":
/*!**************************************************!*\
  !*** ./src/app/content/devops-toolchain.page.ts ***!
  \**************************************************/
/*! exports provided: DevopsToolchainPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DevopsToolchainPage", function() { return DevopsToolchainPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


/* tslint:disable */
var DevopsToolchainPage = /** @class */ (function () {
    function DevopsToolchainPage() {
    }
    DevopsToolchainPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'content-devops-toolchain',
            template: "<ion-header>\n    <ion-toolbar>\n        <ion-buttons slot=\"start\">\n            <ion-back-button></ion-back-button>\n        </ion-buttons>\n        <ion-title>\n            <a routerLink=\"/\">Ourchitecture</a>\n        </ion-title>\n        <ion-buttons slot=\"end\">\n            <ion-button fill=\"solid\" href=\"https://github.com/ourchitecture\">\n                <ion-icon slot=\"end\" name=\"logo-github\"></ion-icon>\n                GitHub\n            </ion-button>\n        </ion-buttons>\n    </ion-toolbar>\n</ion-header>\n\n<ion-content>\n    <div class=\"ion-padding\">\n<h1 id=\"devopstoolchain\">DevOps Toolchain</h1>\n<h2 id=\"pipelines\">Pipelines</h2>\n<p>Checkout the <a href=\"https://github.com/ligurio/awesome-ci\">open list of Continuous Integration services</a>.</p>\n<h3 id=\"opensource\">Open Source</h3>\n<ul>\n<li><a href=\"https://concourse-ci.org/\">Concourse</a></li>\n<li><a href=\"https://jenkins.io/\">Jenkins</a></li>\n<li><a href=\"https://www.spinnaker.io/\">Spinnaker</a></li>\n</ul>\n<h3 id=\"proprietary\">Proprietary</h3>\n<h4 id=\"freeforopensource\">Free for Open Source</h4>\n<ul>\n<li><a href=\"https://www.appveyor.com/\">AppVeyor</a></li>\n<li><a href=\"https://circleci.com\">CircleCI</a></li>\n<li><a href=\"https://cirrus-ci.com/\">Cirrus CI</a></li>\n<li><a href=\"https://travis-ci.org\">Travis CI</a></li>\n</ul>\n<h4 id=\"paid\">Paid</h4>\n<ul>\n<li><a href=\"https://aws.amazon.com/devops/\">Amazon DevOps</a></li>\n<li><a href=\"https://cloud.google.com/cloud-build/\">Google Cloud Build</a></li>\n<li><a href=\"https://www.ibm.com/cloud/devops\">IBM Cloud DevOps</a></li>\n<li><a href=\"https://azure.microsoft.com/en-us/services/devops/\">Microsoft Azure DevOps</a></li>\n<li><a href=\"https://www.jetbrains.com/teamcity/\">TeamCity</a></li>\n</ul>\n<h2 id=\"codecoverage\">Code Coverage</h2>\n<h3 id=\"opensource-1\">Open Source</h3>\n<ul>\n<li><a href=\"https://github.com/tonerdo/coverlet\">.NET: Coverlet</a></li>\n<li><a href=\"https://istanbul.js.org/\">JS: Istanbul</a></li>\n<li><a href=\"https://www.eclemma.org/jacoco/\">Java: JaCoCo</a></li>\n</ul>\n<h3 id=\"proprietary-1\">Proprietary</h3>\n<h4 id=\"freeforopensource-1\">Free for Open Source</h4>\n<ul>\n<li><a href=\"https://codecov.io/\">CodeCov</a></li>\n</ul>\n<h2 id=\"packagemanagement\">Package Management</h2>\n<h3 id=\"opensource-2\">Open Source</h3>\n<ul>\n<li><a href=\"https://www.nuget.org/\">.NET: Nuget</a></li>\n<li><a href=\"https://www.debian.org/distrib/packages\">Debian: Packages</a></li>\n<li><a href=\"https://go-search.org/\">Go</a></li>\n<li><a href=\"https://github.com/features/package-registry\">GitHub Package Registry</a></li>\n<li><a href=\"https://mvnrepository.com/\">Java: Maven</a></li>\n<li><a href=\"https://jfrog.com/artifactory/\">jFrog Artifactory</a></li>\n<li><a href=\"https://npmjs.com\">JS: NPM</a></li>\n<li><a href=\"https://pypi.org/\">Python: PyPI</a></li>\n<li><a href=\"https://rubygems.org/\">Ruby: Gems</a></li>\n<li><a href=\"https://www.sonatype.com/nexus-repository-sonatype\">Sonatype Nexus</a></li>\n</ul>\n<h2 id=\"riskscans\">Risk Scans</h2>\n<h3 id=\"opensource-3\">Open Source</h3>\n<ul>\n<li><a href=\"https://anchore.com/\">Containers: Anchore</a></li>\n<li><a href=\"https://github.com/findbugsproject/findbugs\">Java: FindBugs</a></li>\n<li><a href=\"https://www.sonarqube.org/\">SonarQube</a></li>\n</ul>\n<h3 id=\"proprietary-2\">Proprietary</h3>\n<h4 id=\"freeforopensource-2\">Free for Open Source</h4>\n<ul>\n<li><a href=\"https://scan.coverity.com/\">Coverity</a></li>\n</ul>\n<h4 id=\"paid-1\">Paid</h4>\n<ul>\n<li><a href=\"https://jfrog.com/xray/\">jFrog XRay</a></li>\n<li><a href=\"https://www.sonatype.com/nexus-iq-server\">Nexus IQ</a></li>\n</ul>\n    </div>\n</ion-content>",
            styles: [__webpack_require__(/*! ./content.scss */ "./src/app/content/content.scss")]
        })
    ], DevopsToolchainPage);
    return DevopsToolchainPage;
}());
...
/***/ "./src/app/content/testing.page.ts":
/*!*****************************************!*\
  !*** ./src/app/content/testing.page.ts ***!
  \*****************************************/
